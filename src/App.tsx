...
import { ToMatchingPageButton } from './components/Buttons/ToMatchingPageButton';
		...
		<div className='min-h-screen bg-gradient-to-r from-blue-50 via-white to-blue-50'>
			...
			<div className='container mx-auto flex flex-col lg:flex-row h-screen items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8 px-4'>
				...
				<div className='lg:w-1/2 flex flex-col space-y-4 animate-fade-in'>
					<h2 className='text-2xl font-bold text-center text-gray-700'>さあ、繋がろう</h2>
					<div className='grid grid-cols-2 gap-4'>
						<ToIntroductionPageButton>自己紹介を見る</ToIntroductionPageButton>
						<ToProductsPageButton>成果物を見る</ToProductsPageButton>
						<ToPostIntroductionPageButton>
							自己紹介を投稿する
						</ToPostIntroductionPageButton>
						<ToPostProductsPageButton>成果物を投稿する</ToPostProductsPageButton>
						<ToMatchingPageButton>誰かとつながる</ToMatchingPageButton>
					</div>
				</div>
			</div>
		</div>
