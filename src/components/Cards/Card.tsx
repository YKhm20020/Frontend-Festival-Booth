	...
	return (
		<>
			<div className='flex justify-center w-full'>
				<div
					className='relative group flex flex-col shadow-2xl rounded-xl overflow-hidden w-60 md:w-72 lg:w-80 cursor-pointer transition-all duration-300 ease-in-out
                    hover:scale-105'
					onClick={openModal}
				>
					<img
