...
type ToMatchingPageButtonProps = {
	children: React.ReactNode;
};
export const ToMatchingPageButton: React.FC<ToMatchingPageButtonProps> = ({
	children,
}: ToMatchingPageButtonProps) => {
	const navigate = useNavigate();

	return (
		<button
			className='relative inline-sky-700 px-4 py-2 font-medium group btn-primary'
