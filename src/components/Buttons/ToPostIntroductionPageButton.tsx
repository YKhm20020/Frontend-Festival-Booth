...
type ToPostIntroductionPageButtonProps = {
	children: React.ReactNode;
};

export const ToPostIntroductionPageButton: React.FC<ToPostIntroductionPageButtonProps> = ({
	children,
}: ToPostIntroductionPageButtonProps) => {
